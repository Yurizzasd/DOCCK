...
// Se a imagem falhar, um fallback com a marca mantém o grid intacto.
        ...
        <span className="clip-corner-sm block overflow-hidden bg-ink-850">
          <span className="relative block aspect-[4/3] overflow-hidden bg-ink-700">
            {showImg ? (
              ...
              <span className="grid h-full w-full place-items-center bg-ink-800">
                <img src="/logo.png" alt="" aria-hidden="true" className="h-16 w-auto rounded-lg opacity-40" />
              </span>
            )}
