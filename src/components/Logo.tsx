...
// Usa a logo oficial se existir em /public/logo.png (basta salvar o arquivo lá).
// Caso contrário, usa a marca SVG temporária inspirada na identidade âmbar/vermelho.
