...
- Placeholders neutros enquanto `VITE_ADS_PROVIDER` estiver vazio; nunca cobrem o botão de download.
- Slots existentes: `home-banner`, `catalog-infeed`, `detail-top`, `detail-side`.
